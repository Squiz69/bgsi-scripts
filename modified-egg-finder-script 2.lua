...
-- Main script loop with fixed egg processing and corrected timer handling
local function mainLoop()
    if isSearching then return end
    isSearching = true
    
    print("------- 25x Priority Egg Finder v4.5 Started -------")
...
title.TextSize = 16
title.Text = "25x Priority Egg Finder v4.5"
title.Parent = frame
...
print("🚀 25x Priority Egg Finder v4.5 initialized")
