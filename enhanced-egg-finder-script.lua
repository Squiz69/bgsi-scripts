...
-- Enhanced Discord webhook notification function with better error handling and 3-second wait
local function sendDiscordNotification(eggInfo, eggLuck)
    if not eggInfo then return end
    
    -- Wait 3 seconds to ensure webhook has time to process
    wait(3)
...
-- Optimized main loop with improved egg handling
...
print("🚀 25x Egg Finder v3.3 initialized")
