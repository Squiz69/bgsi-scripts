...
-- Fixed Discord webhook function with proper error handling
local function sendDiscordNotification(eggInfo, eggLuck)
if not eggInfo then return end

-- Create a separate thread to handle webhook
spawn(function()
...
-- Calculate time remaining (fixed to use 60 seconds as baseline)
