...
-- Improved ground-based tweening function (no flying/teleporting)
local function tweenToEgg(egg)
    ...
    -- Create tween to egg ground position
    local tweenInfo = TweenInfo.new(
        distance / (tweenSpeed * 10), -- Adjusted for speed 8
        Enum.EasingStyle.Linear
    )
    
    currentTween = TweenService:Create(humanoidRootPart, tweenInfo, {
        CFrame = CFrame.new(groundPosition) * CFrame.new(0, 0, -3) -- Offset slightly
    })
