        ...
        embeds = {
            {
                ...
                footer = {text = "25x Priority Egg Finder v4.4"}, -- Updated version number
...
local function mainLoop()
    ...
    print("------- 25x Priority Egg Finder v4.4 Started -------")
...
title.TextSize = 16
title.Text = "25x Priority Egg Finder v4.4"
title.Parent = frame
...
print("🚀 25x Priority Egg Finder v4.4 initialized")
